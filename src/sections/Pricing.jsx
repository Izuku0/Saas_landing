    ...
    <section>
        <Element name='pricing'>
            <div className='container'>
                <div className='max-w-980 pricing-head_before relative  mx-auto  bg-s1/50 pb-40 pt-28 max-xl:max-w-4xl max-lg:border-none max-md:pb-32 max-md:pt-16'>
              ...
              >
                ...
                <div className='scroll-hide relative z-2 -mt-12 flex items-start max-xl:gap-5 max-xl:overflow-auto max-xl:pt-6'>
                    {plans.map((plan,index) =>(
                        <div key={plan.id} className='pricing-plan_first pricing-plan_last pricing-plan_odd pricing-plan_even relative border-2 p-7 max-xl:min-2-80 max-lg:rounded-3xl xl:w-[calc(33.33%+2px)]'>
                           {index===1 && (
                           ...
                           <div className={clsx('relative flex flex-col items-center',index===1 ? 'pt-24':'pt-12')}>
                            ...
                            <div className='realtive z-2 flex items-center justify-center'>
                           ...
                           {index===1 && <p className="small-compact mt-9 text-center text-p3 before:mx-2.5 before:content-['-'] after:mx-2.5 after:content-['-']">Limited Time</p>}
                        </div>
                    ))}
                </div>
            </div>
